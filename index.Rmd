...
# ATAC peaks overlapping K36me2 peaks
...
```{r echo = FALSE, warning=FALSE,message=FALSE,out.width='100%'}
library(htmltools)
htmltools::includeHTML('~/Documents/10T_K36me2/data/motif.output/QKO_c1.overlapATAC.longer.merged.sizeGiven/knownResults.html')
```
