...
# Aggregate plot
```{r,aggregate_plot,echo = FALSE,fig.show = "hold", out.width = "100%", fig.align = "default"}
knitr::include_graphics("~/Documents/10T_K36me2/images/aggregate.ATAC.profile.png")
```
