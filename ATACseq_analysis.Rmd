...
volc(resLFC,'log2FoldChange','padj','log2FoldChange TKO/PA','-log10(FDR)','',cutoff = 1)
...
### |log2FC| > 2
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange TKO/PA','-log10(FDR)','',cutoff = 2)
# check direction of shrinkage
# res <- results(dds,contrast = c("condition","TKO","PA"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
### |log2FC| > 2.5
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange TKO/PA','-log10(FDR)','',cutoff = 2.5)
# check direction of shrinkage
# res <- results(dds,contrast = c("condition","TKO","PA"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
### |log2FC| > 3
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange TKO/PA','-log10(FDR)','',cutoff = 3)
# check direction of shrinkage
# res <- results(dds,contrast = c("condition","TKO","PA"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
### |log2FC| > 4
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange TKO/PA','-log10(FDR)','',cutoff = 4)
# check direction of shrinkage
# res <- results(dds,contrast = c("condition","TKO","PA"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
volc(resLFC,'log2FoldChange','padj','log2FoldChange QKO/PA','-log10(FDR)','',cutoff = 1)
#
...
### |log2FC| > 2
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange QKO/PA','-log10(FDR)','',cutoff = 2)
#
# res <- results(dds,contrast = c("condition","QKO","PA"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
### |log2FC| > 2.5
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange QKO/PA','-log10(FDR)','',cutoff = 2.5)
#
# res <- results(dds,contrast = c("condition","QKO","PA"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
### |log2FC| > 3
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange QKO/PA','-log10(FDR)','',cutoff = 3)
#
# res <- results(dds,contrast = c("condition","QKO","PA"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
### |log2FC| > 4
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange QKO/PA','-log10(FDR)','',cutoff = 4)
#
# res <- results(dds,contrast = c("condition","QKO","PA"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
volc(resLFC,'log2FoldChange','padj','log2FoldChange QKO/TKO','-log10(FDR)','',cutoff = 1)
#
...
### |log2FC| > 2
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange QKO/TKO','-log10(FDR)','',cutoff = 2)
#
# res <- results(dds,contrast = c("condition","QKO","TKO"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
### |log2FC| > 2.5
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange QKO/TKO','-log10(FDR)','',cutoff = 2.5)
#
# res <- results(dds,contrast = c("condition","QKO","TKO"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
### |log2FC| > 3
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange QKO/TKO','-log10(FDR)','',cutoff = 3)
#
# res <- results(dds,contrast = c("condition","QKO","TKO"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
...
### |log2FC| > 4
```{r,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
volc(resLFC,'log2FoldChange','padj','log2FoldChange QKO/TKO','-log10(FDR)','',cutoff = 4)
#
# res <- results(dds,contrast = c("condition","QKO","TKO"))
# volc(res,'log2FoldChange','padj','-log10(FDR)','')
```
