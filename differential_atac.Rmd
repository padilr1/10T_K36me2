...
# Table of overlap
```{r,table_ol,echo = FALSE, out.width = "100%", fig.align = "default",message=FALSE,warning=FALSE}
...
imageList <- list.files("~/Documents/10T_K36me2/data/differential.ATACseq.regions", pattern= "*ATAC.profile.png", full.names=T)
